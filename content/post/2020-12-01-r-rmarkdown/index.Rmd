...
<<<<<<< HEAD
myPlot <- ggplot(response2, aes(x= date, y= value, group= region, color= contractorType)) +
  geom_point() +
  geom_path()
...
# 
# response2 %>% 
#   group_by(region, contractorType) %>% 
#   plot_ly(x=~date, y = ~value, group=~region, type="scatter", color= ~contractorType)
=======
# myPlot <- ggplot(response2, aes(x= date, y= value, group= region, color= contractorType)) +
#   geom_point() +
#   geom_path()
...
response2 %>% 
  group_by(region, contractorType) %>% 
  plot_ly(x=~date, y = ~value, group=~region, type="scatter", color= ~contractorType)
>>>>>>> 2377c314d7b0426c61e864b909882a413d928cab
